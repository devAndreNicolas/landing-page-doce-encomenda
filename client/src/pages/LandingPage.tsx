    ...
    <div className="min-h-screen font-sans bg-background selection:bg-primary/20">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Button size="sm" onClick={goToApp} variant="outline" className="font-bold">Login</Button>
            <Button size="sm" onClick={goToApp} className="font-bold">Começar Agora</Button>
          </div>
          ...
          {isMenuOpen && (
            ...
            >
              <div className="px-4 pt-2 pb-6 space-y-4">
                <button onClick={() => scrollToSection('features')} className="block w-full text-left px-3 py-2 text-base font-medium text-gray-600">Operação</button>
                <button onClick={() => scrollToSection('pricing')} className="block w-full text-left px-3 py-2 text-base font-medium text-gray-600">Planos</button>
                <button onClick={() => scrollToSection('faq')} className="block w-full text-left px-3 py-2 text-base font-medium text-gray-600">Dúvidas</button>
                <div className="pt-4 flex flex-col gap-3">
                  <Button onClick={goToApp} variant="outline" className="w-full font-bold">Acessar Painel</Button>
                  <Button onClick={goToApp} className="w-full font-bold">Criar Minha Vitrine</Button>
                </div>
              </div>
            </motion.div>
          )}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-10">
                <Button size="lg" variant="cta" onClick={goToApp} className="text-base group font-bold">
                ...
                <div className="flex -space-x-3">
                  {[1, 2, 3, 4].map(i => (
                    <div key={i} className="w-10 h-10 rounded-full border-2 border-white bg-gray-200 overflow-hidden">
                      <img src={`https://i.pravatar.cc/100?img=${i + 15}`} alt="Empreendedora" />
                    </div>
                  ))}
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl border border-white/50 text-center">
                ...
                <Button size="lg" className="w-full h-14 text-lg font-bold shadow-lg" onClick={goToApp}>
                  Quero escalar meu faturamento agora
                </Button>
      ...
      <section className="py-20 bg-white" id="pricing">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-display font-bold text-gray-900 mb-4">
              Investimento menor que um Cento de Doces
            </h2>
            <p className="text-gray-600 text-lg">
              Recupere seu investimento na primeira encomenda que o sistema fechar por você.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col p-8 rounded-3xl border border-gray-100 bg-gray-50/50 hover:border-gray-200 transition-colors">
              ...
              <Button variant="outline" className="w-full mt-auto font-bold" onClick={goToApp}>Começar Agora</Button>
            </div>

            {/* Pro Tier */}
            <div className="flex flex-col p-8 rounded-3xl border-2 border-primary bg-white shadow-xl relative overflow-hidden">
              ...
              <Button variant="default" className="w-full mt-auto font-bold shadow-lg" onClick={() => window.open('https://wa.me/5599999999999?text=Quero%20profissionalizar%20meu%20negócio%20com%20o%20plano%20Pro', '_blank')}>Escalar meu Faturamento</Button>
            </div>
          </div>
        </div>
      </section>
